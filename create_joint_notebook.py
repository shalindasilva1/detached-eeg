...
with open('/Users/buraa/Repo/detached-eeg/notebooks/pipeline_joint_standalone.ipynb', 'w') as f:
    json.dump(notebook, f, indent=2)
print('Successfully recreated notebooks/pipeline_joint_standalone.ipynb')
